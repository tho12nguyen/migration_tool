...
SHEET_CONFIG_MAP = {
    ...
    "type1": {"number_header_rows": 1, "filter_columns": ["A", "C"], "num_cols": 7},
    "type2": {"number_header_rows": 1, "filter_columns": ["A", "C"], "num_cols": 7},
    "type3": {"number_header_rows": 1, "filter_columns": ["A", "C"], "num_cols": 7},
}
